...
func (r *checkRunRepository) Enqueue(tx lit.Executor, run *models.CheckRun) (int, error) {
	return lit.Insert[models.CheckRun](tx, run)
}

func (r *checkRunRepository) FindById(tx lit.Executor, id int) (*models.CheckRun, error) {
...
func (r *checkRunRepository) FindClaimable(tx lit.Executor, typeA string, typeB string, typeC string, now time.Time, limit int) ([]*models.CheckRun, error) {
...
func (r *checkRunRepository) FindClaimableBrowser(tx lit.Executor, now time.Time, limit int) ([]*models.CheckRun, error) {
	return lit.SelectNamed[models.CheckRun](
		tx,
...
func (r *checkRunRepository) Claim(tx lit.Executor, id int, claimedBy string, now time.Time) (bool, error) {
...
func (r *checkRunRepository) Delete(tx lit.Executor, id int) error {
...
func (r *checkRunRepository) DeleteClaimedBy(tx lit.Executor, id int, claimedBy string) (bool, error) {
...
func (r *checkRunRepository) DeleteQueuedByCheck(tx lit.Executor, checkId int) error {
...
func (r *checkRunRepository) ReclaimStaleClaimed(tx lit.Executor, cutoff time.Time) error {
	query, args, err := lit.ParseNamedQuery(
		db.Driver,
...
func (r *checkRunRepository) FindExpiredQueued(tx lit.Executor, now time.Time, limit int) ([]*models.CheckRun, error) {
	return lit.SelectNamed[models.CheckRun](
		tx,
...
func (r *checkRunRepository) HasPendingForCheck(tx lit.Executor, checkId int) (bool, error) {
...
func (r *checkRunRepository) CountsForHealth(tx lit.Executor) (*models.CheckRunHealthCounts, error) {
...
func (r *checkRunRepository) OldestQueued(tx lit.Executor) (*models.CheckRun, error) {
	return lit.SelectSingleNamed[models.CheckRun](
		tx,
