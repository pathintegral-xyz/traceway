...
func (r *userNotificationRuleRepository) FindByUser(tx lit.Executor, userId int) ([]*models.UserNotificationRule, error) {
...
func (r *userNotificationRuleRepository) FindByUserAndUrgency(tx lit.Executor, userId int, urgency string) ([]*models.UserNotificationRule, error) {
	return lit.SelectNamed[models.UserNotificationRule](
		tx,
...
func (r *userNotificationRuleRepository) ReplaceForUser(tx lit.Executor, userId int, rules []*models.UserNotificationRule) error {
