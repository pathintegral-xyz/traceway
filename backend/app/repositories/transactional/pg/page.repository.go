...
func (r *pageRepository) FindById(tx lit.Executor, id int) (*models.Page, error) {
...
func (r *pageRepository) FindUnresolvedByDedupKey(tx lit.Executor, dedupKey string) (*models.Page, error) {
	return lit.SelectSingleNamed[models.Page](
		tx,
...
func (r *pageRepository) BumpEvent(tx lit.Executor, id int, now time.Time) error {
...
func (r *pageRepository) FindDueById(tx lit.Executor, id int, now time.Time) (*models.Page, error) {
	return lit.SelectSingleNamed[models.Page](
		tx,
...
func (r *pageRepository) FindDue(tx lit.Executor, now time.Time) ([]*models.Page, error) {
...
func (r *pageRepository) FindUnresolvedByIssueHash(tx lit.Executor, projectId uuid.UUID, hash string) ([]*models.Page, error) {
	return lit.SelectNamed[models.Page](
		tx,
...
func (r *pageRepository) FindByProject(tx lit.Executor, projectId uuid.UUID, status string, limit int, offset int) ([]*models.Page, error) {
	return lit.SelectNamed[models.Page](
		tx,
...
func (r *pageRepository) CountByProject(tx lit.Executor, projectId uuid.UUID, status string) (int, error) {
...
func (r *pageRepository) CountOpenByProject(tx lit.Executor, projectId uuid.UUID) (int, error) {
	return r.CountByProject(tx, projectId, models.PageStatusOpen)
}

func (r *pageRepository) FindByOrganization(tx lit.Executor, organizationId int, status string, limit int, offset int) ([]*models.Page, error) {
	return lit.SelectNamed[models.Page](
		tx,
...
func (r *pageRepository) CountByOrganization(tx lit.Executor, organizationId int, status string) (int, error) {
	result, err := lit.SelectSingleNamed[models.CountResult](
		tx,
...
func (r *pageRepository) Create(tx lit.Executor, page *models.Page) (int, error) {
...
func (r *pageRepository) UpdateEscalationState(tx lit.Executor, id int, level int, iteration int, nextEscalationAt *time.Time, now time.Time) (bool, error) {
	var nextValue any
...
func (r *pageRepository) Acknowledge(tx lit.Executor, id int, userId *int, via string, now time.Time) (bool, error) {
	var userValue any
	if userId != nil {
		userValue = *userId
	}
...
func (r *pageRepository) Resolve(tx lit.Executor, id int, userId int, now time.Time) (bool, error) {
	return guardedStatusUpdate(
		tx,
...
func (r *pageRepository) ResolveSystem(tx lit.Executor, id int, now time.Time) (bool, error) {
	return guardedStatusUpdate(
		tx,
...
func (r *pageRepository) FindByOrganizationFiltered(tx lit.Executor, organizationId int, status string, search string, from, to *time.Time, limit int, offset int) ([]*models.Page, error) {
...
func (r *pageRepository) CountByOrganizationFiltered(tx lit.Executor, organizationId int, status string, search string, from, to *time.Time) (int, error) {
