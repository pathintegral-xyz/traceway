...
var ProjectLimitHook func(tx lit.Executor, orgId int) error

var MemberLimitHook func(tx lit.Executor, orgId int) error
...
var CheckLimitHook func(tx lit.Executor, orgId int) error
...
var OrganizationLimitHook func(tx lit.Executor, userId int) error
