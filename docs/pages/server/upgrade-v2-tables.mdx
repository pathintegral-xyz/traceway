...
|----------|---------|----------|
| `V2_MOVE_OVER` | unset; disabled | `true` enables background copying in this backend process |
| `V2_MOVE_OVER_OLDEST` | unset | Inclusive oldest UTC source day, formatted `YYYY-MM-DD`; older days are left in the old tables |
| `V2_MOVE_OVER_WORKERS` | `1` | Number of source days copied concurrently in this instance; capped at `16`. Unset, invalid or non-positive values use `1` |
